...
Private fork of `mattpocock/skills` that keeps the upstream skill set and adds Linear-aware setup for the `Theroomofrequirement` / `THE` workflow.
...
```bash
npx skills@latest add jessewalberg/skills
```
